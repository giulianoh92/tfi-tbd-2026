...
-- tabla y las consultas con lower(nombre) lo exigen.
INSERT INTO estado_vehiculo (nombre, descripcion) VALUES
    ...
    -- Estado terminal para baja de flota (R3). Como la estructura de la base
    -- no tiene baja logica sobre `vehiculo`, pa_baja_vehiculo transiciona
