...
-- uq_historial_estado_vigente sostiene la invariante en la base de datos. Los
-- disparadores de ciclo de vida (activados por los datos posteriores de alquiler
-- y mantenimiento) cierran estas filas y abren las siguientes a medida
-- que la maquina de estados evoluciona.
