...
--
-- Soportan las claves forneas y las consultas tipicas del panel: alquileres
-- por cliente, por vehiculo, por sucursal de devolucion. El indice por estado
-- alimenta la vista vw_alquileres_activos. El indice por (fecha_inicio,
-- fecha_fin_prevista) acompana la validacion de solapamiento temporal del
-- disparador fn_check_vehiculo_overlap antes de que actue la EXCLUDE.
