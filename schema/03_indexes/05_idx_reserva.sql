...
--
-- Soportan las FKs (cliente, vehiculo, tipo_reserva), el filtro por
-- estado del panel /admin/reservas y la consulta de superposicion
-- temporal por (fecha_inicio, fecha_fin_prevista) que pa_registrar
-- _reserva ejecuta antes de insertar.
