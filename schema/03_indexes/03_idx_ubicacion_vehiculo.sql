...
--
-- Los dos primeros soportan las FKs y los JOINs por vehiculo/sucursal.
-- El UNIQUE PARCIAL uq_ubicacion_vehiculo_vigente garantiza UNA SOLA fila
-- vigente (fecha_hasta IS NULL) por vehiculo: el trigger de lifecycle, al
-- cambiar ubicacion, debe cerrar la fila anterior antes de insertar la
-- nueva. Cualquier bug que intente dejar dos filas vigentes simultaneas
