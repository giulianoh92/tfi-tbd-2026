...
-- NULL y dispara el trigger fn_mantenimiento_lifecycle que transiciona al
-- vehiculo a estado 'en_mantenimiento'; pa_registrar_devolucion
-- _mantenimiento completa fecha_devolucion y el trigger devuelve al
